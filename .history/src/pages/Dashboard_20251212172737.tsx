...
// KEEP lucide-react as you requested
...
export default function Dashboard(): JSX.Element {
  ...
  // <-- ADDED: query state for the search input
  ...
  // <-- ADDED: filteredEmployees so search filters the table
        ...
        <main className="col-span-9">
          ...
          <header className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              {/* Search input — uses query/setQuery and has a minWidth to ensure visibility */}
              <div className="relative" style={{ minWidth: 220 }}>
                <input
                  value={query}
                  onChange={(ev) => setQuery(ev.target.value)}
                  type="text"
                  placeholder="Search employees, role, team..."
                  className="px-4 py-2 pr-10 rounded-full bg-white shadow-sm border border-gray-200 focus:outline-none focus:border-emerald-400 transition w-full"
                  aria-label="Search"
                />
                <svg
                ...
                >
                  <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-4.35-4.35m0 0A7.5 7.5 0 105.65 5.65a7.5 7.5 0 0010.6 10.6z" />
                </svg>
              </div>
          ...
          <section className="grid grid-cols-2 gap-4 mt-6">
            ...
            >
              ...
              >
                {/* PASS FILTERED EMPLOYEES so search works */}
                <EmployeeTable
