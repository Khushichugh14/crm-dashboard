    ...
    <div className="min-h-screen p-6 bg-gradient-to-br from-slate-50 via-emerald-50 to-violet-50 font-sans">
      <div className="max-w-[1300px] mx-auto grid grid-cols-12 gap-6">
        ...
        <main className="col-span-9">
          ...
          import {Users, Star, Wallet, TrendingUp} from "lucide-react";
...
const DashboardStats = () => {
  return (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            ...
            {/* Average Score */}
            <div className="p-6 rounded-2xl shadow-sm bg-gradient-to-br from-[#EEF6FF] to-[#F7FBFF]">
              <div className="flex justify-between items-center">
                <h2 className="text-gray-600 text-lg font-medium">Average Score</h2>
                <Star className="text-blue-500" size={28} />
              </div>
              <p className="text-4xl font-bold mt-3">7.5</p>
              <p className="text-sm text-gray-500">Performance (0–10)</p>
            </div>

            {/* Payroll */}
            <div className="p-6 rounded-2xl shadow-sm bg-gradient-to-br from-[#FFF7EA] to-[#FFFDF6]">
              <div className="flex justify-between items-center">
                <h2 className="text-gray-600 text-lg font-medium">Payroll</h2>
                <Wallet className="text-yellow-500" size={28} />
              </div>
              <p className="text-4xl font-bold mt-3">$529.0k</p>
