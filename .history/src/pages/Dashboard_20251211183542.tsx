          ...
          <section className="grid grid-cols-2 gap-4">
            ...
            <div style={{ position: "relative" }}>
              <div style={{ position: "sticky", top: 24 }}>
                <div style={{ background: THEME.cardBg, border: `1px solid ${THEME.cardBorder}`, borderRadius: THEME.cardRadius, boxShadow: THEME.glassShadow, padding: 16, marginBottom: 12 }}>
                  <h3 className="font-medium text-slate-700 mb-2">Team statistics</h3>
                  <div className="grid grid-cols-2 gap-3">
                    <MiniCard label="POSSESSION" value="65%" icon={"/src/assets/icons/possession.png"} />
                    <MiniCard label="OVERALL PRICE" value="$690.2m" icon={"/src/assets/icons/price.png"} />
                    <MiniCard label="TRANSFER BUDGET" value="$240.6m" icon={"/src/assets/icons/budget.png"} />
                    <MiniCard label="AVERAGE SCORE" value="7.2" icon={"/src/assets/icons/score.png"} />
                  </div>
                </div>
