...
export default function EmployeeTable({ employees,  }: Props) {
  return (
    <div className="table-root <div className= hide-scrollbar overflow-auto">
      <table className="table-fixed w-full" style={{ borderCollapse: "collapse" }}>
        ...
        <thead>
          <tr className="text-sm text-slate-600 <div className="hide-scrollbar overflow-auto" style={{ borderBottom: "1px solid rgba(14,30,37,0.06)" }}>
