...
export default function EmployeeTable({ employees, onEdit, onDelete }: Props) {
  return (
    <div className="table-root">
      {/* table-fixed + w-full makes column widths stable */}
...
\              <td className="py-4 text-sm text-slate-700 align-middle">{i + 1}</td>
              ...
              {/* Name column: avatar + stacked name (wraps) */}
              <td className="py-4 align-middle">
                <div className="flex items-start gap-3">
                  {/* avatar circle (keeps fixed size) */}
                  <div
                    ...
                    style={{
                      ...
                      // If e.avatarColor is a tailwind class like 'bg-rose-400', it will not apply via style.
                      // If you used tailwind color classes, keep className. Otherwise set a hex here.
                    }}
                  >
                    {/* show initials */}
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div className="font-medium text-slate-800 leading-tight">
                      {/* force name to wrap across two lines if needed */}
              ...
              {/* Perf - full-width bar inside its column */}
              <td className="py-4 align-middle">
