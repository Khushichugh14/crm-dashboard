...
export default function Header({ query, setQuery }: { query: string; setQuery: (v: string) => void; }) {
  return (
    <header className="flex items-center justify-between mb-6">
      ...
      <div className="flex items-center gap-4">
        <input value={query} onChange={(e)=>setQuery(e.target.value)} placeholder="Search employees or role..." className="px-4 py-2 rounded-full border border-white/40 bg-white/60 backdrop-blur-sm" />
